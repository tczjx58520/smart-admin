...
export const regularWorker = {
  // 查询转正合同
  getregularWorker: (data) => {
    let Form = new FormData();
    if (data.empConversionId !== undefined && data.empConversionId !== null && data.empConversionId !== '') {
      Form.append('empConversionId', data.empConversionId);
    }
    ...
    return postAxios('/empConversion/empConversionList', Form);
  },
  // 添加转正合同
  addregularWorker: data => {
    let Form = new FormData();
