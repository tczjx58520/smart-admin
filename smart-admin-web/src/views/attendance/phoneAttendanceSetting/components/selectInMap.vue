<template>
        <Modal v-model="mymoadlStat" class="add" width="1200" :closable="false" :mask-closable="false" :transfer="false" :styles="{top: '10px'}">
   <Card dis-hover>
     <div>
       <div>
   ...
   <div slot="footer">
            <ButtonGroup>
                <Button type="primary" size="large" @click="handsave">{{ $t('Save') }}</Button>
