    ...
    <div>
            <div class="rightTop">
                <Button @click="resetFirstTable" icon="md-refresh" type="default" style="margin-right:15px;">{{ $t('Reflash') }}</Button>
                  <Button style="margin-right:15px;" @click="handleAdd" icon="md-add" type="warning">{{ $t('Create') }}</Button>
            ...
            <Tables
                    ...
                    show-elevator
                  ></Tables>
                  <firstFrom :modalstat.sync ='modalstat' :modalState.sync="modalState" :editData.sync='editData' @restList="restList"/>
    </div>
</template>
