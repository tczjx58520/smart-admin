        ...
        <TabPane :label="$t('kqgl.txj')">
            <div class="rightTop">
               ...
               <div class="rightTopItem">
                   ...
                   <span>
                        <DatePicker type="year" v-model="year" placeholder="Select year" style="width: 200px"/>
                   </span>
               </div>
                <div class="rightTopItem">
                   <span class="rightTopItemTitle">{{$t('kqgl.yhm')}}</span>
                   <span>
                        <Input placeholder="请输入用户名" :value="organizationName" type="text" @click.native="selectOrg()"/>
                   </span>
