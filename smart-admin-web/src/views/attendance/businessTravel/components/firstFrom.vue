                ...
                <Form ref="form" :model="fromBaseData" label-position="right" :label-width="100" :rules="ruleValidate">
                  <FormItem :label="$t('kqgl.liuchengbianhao')">
                    ...
                    <div class="nomalDiv">
                        ...
                        <DatePicker type="date" :value="fromBaseData.startTime" confirm style="width: 20%" @on-change="changeStartTime"/>
                        <div class="zhi">{{$t('kqgl.zhi')}}</div>
                        <DatePicker type="date" :value="fromBaseData.endTime" confirm style="width: 20%" @on-change="changeEndTime"/>
  ...
  methods: {
      ...
      countTotalTime() {
          if (this.fromBaseData.endTime && this.fromBaseData.startTime) {
              ...
              let tian1 = this.datedifference(this.fromBaseData.startTime,this.fromBaseData.endTime)
              console.log(tian1)
