    ...
    <div>
            <div class="rightTop">
               ...
               <div class="rightTopItem">
                   ...
                   <span>
                        <Input v-model="firstTable.employeeName" type="text" />
                   </span>
                ...
                <div class="rightTopItem">
                   ...
                   <span>
                        <Input :value="organizationName" clearable type="text" @on-focus="selectOrg()" @on-clear='clearData'/>
                   </span>
...
selectEmp
    ...
    data() {
        ...
        },
        {
          ...
          editType: 'nomalselect',
           editable: 'true',
          selectData: [{id: 0, name: this.$t('kqgl.yes')}, {id: 1, name: this.$t('kqgl.no')}]
    ...
    methods: {
      clearData() {
        ...
        this.firstTable.organizationId = ''
      },
      editselectData(val) {
        console.log(val)
        let parms = {
...
if (val.column.key === 'attendanceMachineId') {
    ...
    async getFirstTableData () {
      ...
      if(!this.firstTable.organizationId) {
        delete this.firstTable.organizationId
      }
      try {
        this.firstLoading = true;
        let result = await attendance.findAttendanceEmployeeSet(this.firstTable);
