<template>
  ...
  >
    <div slot="header" style="text-align: left; color: #fff">
      <span>{{ $t("kqgl.waichudengjidan") }}</span>
    </div>
    <div>
      <Card dis-hover>
        <div
        ...
        >
          ...
          <div class="nomalDiv">
            <span class="zhi">{{ $t("kqgl.wiachushijian") }}</span>
            <DatePicker
              type="datetimerange"
              v-model="times"
            ...
            ></DatePicker>
            <div class="zhi">{{ $t("kqgl.waichuheji") }}</div>
            <Input
          ...
          <FormItem :label="$t('kqgl.waichishiyou')">
            <Input v-model="fromBaseData.reason" style="width: 34%" />
          </FormItem>
          <FormItem :label="$t('kqgl.waichudidian')">
