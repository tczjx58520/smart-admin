    ...
    <div>
        <TabPane :label="$t('kqgl.kqsz')">
            <div style="margin-bottom:20px;">
              <Button style="margin-right:15px;" @click="newFirstForm" icon="md-add" type="warning">{{ $t('Save') }}</Button>
            </div>
            <div>
                ...
                <Form ref="form" :model="fromBaseData" label-position="left" :label-width="140"  style="padding-top:20px;padding-left:1%">
                        <FormItem :label="$t('kqgl.sbqyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeBeforeFirstStartWork" :min="0" style="width:13%"></InputNumber>

                        </FormItem>

                        <FormItem :label="$t('kqgl.sbhyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeAfterFirstStartWork" :min="0" style="width:13%"></InputNumber>
            ...
            <div>
                ...
                <Form ref="form" :model="fromBaseData" label-position="left" :label-width="140"  style="padding-top:20px;padding-left:1%">
                        <FormItem :label="$t('kqgl.sbqyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeBeforeSecondStartWork" :min="0" style="width:13%"></InputNumber>


                        </FormItem>

                        <FormItem :label="$t('kqgl.sbhyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeAfterSecondStartWork" :min="0" style="width:13%"></InputNumber>
                        </FormItem>
                </Form>
            </div>
             ...
             <div>
                ...
                <Form ref="form" :model="fromBaseData" label-position="left" :label-width="140"  style="padding-top:20px;padding-left:1%">
                        <FormItem :label="$t('kqgl.sbqyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeBeforeThirdStartWork" :min="0" style="width:13%"></InputNumber>

                        </FormItem>

                        <FormItem :label="$t('kqgl.sbhyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeAfterThirdStartWork" :min="0" style="width:13%"></InputNumber>
            ...
            <div>
                ...
                <Form ref="form" :model="fromBaseData" label-position="left" :label-width="140"  style="padding-top:20px;padding-left:1%">
                        <FormItem :label="$t('kqgl.sbqyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeBeforeForthStartWork" :min="0" style="width:13%"></InputNumber>

                        </FormItem>

                        <FormItem :label="$t('kqgl.sbhyxdjsj')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.timeAfterForthStartWork" :min="0" style="width:13%"></InputNumber>
                        </FormItem>
                </Form>
            </div>
            ...
            <div>
                ...
                <Form ref="form" :model="fromBaseData" label-position="left" :label-width="140"  style="padding-top:20px;padding-left:1%">
                        <FormItem :label="$t('kqgl.txsc')"> 
                            <InputNumber :max="100000" v-model="fromBaseData.flexibilityWorkTime" :min="0" style="width:13%"></InputNumber>
                        </FormItem>
                    ...
                    <RadioGroup v-model="fromBaseData.flexibilityWorkType" >
            ...
            <div>
                ...
                <Form ref="form" :model="fromBaseData" label-position="left" :label-width="250"  style="padding-top:20px;padding-left:1%">
                    ...
                    <FormItem :label="$t('kqgl.syry')">
                            <Input type="textarea" disabled  :autosize="{minRows: 4,maxRows: 15}" v-model="fromBaseData.textareaData1" style="width: 34%"/>
                    </FormItem>
                    <div class="buttons">
            ...
            <div>
                ...
                <Form ref="form" :model="fromBaseData" label-position="left" :label-width="140"  style="padding-top:20px;padding-left:1%">
                         <FormItem :label="$t('kqgl.szmqry')" style="padding-top:20px;">
                            <Input type="textarea" :autosize="{minRows: 4,maxRows: 15}" v-model="textareaData5" style="width: 34%" @on-focus ="choosePunchEmp"/>
                        <moreSelectEmp :modalstat.sync="moreSelectEmpVisible3" @empData='getEmpData3' />
                    </FormItem>
                </Form>
            </div>
...
export default {
    ...
    methods: {
     async getDataList(){
        ...
        this.fromBaseData.timeBeforeThirdStartWork = Number(result.data.timeBeforeThirdStartWork)
        this.fromBaseData.timeBeforeSecondStartWork = Number(result.data.timeBeforeSecondStartWork)
        this.fromBaseData.timeBeforeForthStartWork = Number(result.data.timeBeforeForthStartWork)
        this.fromBaseData.timeBeforeFirstStartWork = Number(result.data.timeBeforeFirstStartWork)
        this.fromBaseData.timeAfterThirdStartWork = Number(result.data.timeAfterThirdStartWork)
        this.fromBaseData.timeAfterSecondStartWork = Number(result.data.timeAfterSecondStartWork)
        this.fromBaseData.timeAfterForthStartWork = Number(result.data.timeAfterForthStartWork)
        this.fromBaseData.timeAfterFirstStartWork = Number(result.data.timeAfterFirstStartWork)
        ...
        selectWorkType(val) {
            console.log('val', val)
            if(val.length !== 0) {
                this.fromBaseData.workEarlyType = val[0]
            }
        },
      newFirstForm() {
          ...
          this.fromBaseData.employeeIdForFlex = this.textareaEmpIds.concat(this.textareaEmpIds2)
          this.fromBaseData.organizationForFlex = this.textareaOrgIds.concat(this.textareaOrgIds2)
