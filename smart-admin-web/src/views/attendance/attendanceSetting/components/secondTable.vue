  ...
  <div>
    <TabPane :label="$t('kqgl.bz')">
      ...
      <Table
        ...
        @on-selection-change="selectsecond"
      ></Table>
      <Page
        :current="SecondTable.pageNum"
        :page-size="SecondTable.pageSize"
        :page-size-opts="[10, 20, 30, 50, 100]"
        :total="fistTotal"
        @on-change="secondChangePage"
        @on-page-size-change="secondChangePageSize"
        show-elevator
        show-sizer
        show-total
