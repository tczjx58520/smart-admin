    ...
    <div>
      <Card dis-hover>
        ...
        <Form ref="form"
              ...
              :label-width="100"
              :rules="ruleValidate">
          <FormItem :label="$t('kqgl.bcmc')"
                    prop="shiftName">
            <Input v-model="fromBaseData.shiftName"
                   style="width: 34%" />
          </FormItem>
          <FormItem :label="$t('kqgl.sbsj')"
                    prop="startWorkTimeMorning">
            <TimePicker type="time"
                        v-model="fromBaseData.startWorkTimeMorning"
                        confirm
                        disabled
                        v-if="fromBaseData.whetherVocation===0" />
            <TimePicker type="time"
                        v-model="fromBaseData.startWorkTimeMorning"
                        confirm
                        v-if="fromBaseData.whetherVocation===1" />
          </FormItem>
          <FormItem :label="$t('kqgl.xbsj')"
                    prop="overWorkTimeMorning">
            <TimePicker type="time"
          ...
          <FormItem :label="$t('kqgl.sfswxj')">
            <RadioGroup v-model="fromBaseData.whetherVocation">
              <Radio v-for="item in chooseList"
                     :label="item.value"
                     :key="item.value">
