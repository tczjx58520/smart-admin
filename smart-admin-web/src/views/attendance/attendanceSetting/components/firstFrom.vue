            ...
            <Card dis-hover>
                ...
                <Form ref="form" :model="fromBaseData" label-position="right" :label-width="100" :rules="ruleValidate">
                    ...
                    <FormItem :label="$t('kqgl.sbsj')" prop="startWorkTimeMorning"> 
                        <TimePicker type="time" v-model="fromBaseData.startWorkTimeMorning"  confirm/>
                    </FormItem>
                    <FormItem :label="$t('kqgl.xbsj')" prop="overWorkTimeMorning">
                        <TimePicker type="time"  v-model="fromBaseData.overWorkTimeMorning" confirm/>
                    </FormItem>
                    <FormItem :label="$t('kqgl.sbsj')" prop="startWorkTimeAfternoon">
                        <TimePicker type="time"  v-model="fromBaseData.startWorkTimeAfternoon" confirm/>
                    </FormItem>
                    <FormItem :label="$t('kqgl.xbsj')" prop="overWorkTimeAfternoon">
                        <TimePicker type="time" v-model="fromBaseData.overWorkTimeAfternoon" confirm/>
                    </FormItem>
