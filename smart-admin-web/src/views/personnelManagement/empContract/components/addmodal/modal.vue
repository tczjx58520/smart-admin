        ...
        <Card dis-hover>
          ...
          >
            ...
            <FormItem :label="$t('ygxm')" prop="name" style="width:40%;">
              <Input v-model="addformbase.middleName" :placeholder="$t('xin')" style="width: 33.3%;" />
              <Input v-model="addformbase.lastName" :placeholder="$t('zhongjianmin')" style="width: 33.3%;" />
              <Input v-model="addformbase.firstName" :placeholder="$t('ming')" style="width: 33.3%;" />
            </FormItem>
          ...
          >
            <FormItem :label="$t('sszz')" prop="organizeId" style="width:40%;">
              <Input v-model="addformbase.organizeId" readonly @click.native="showorg_ass"></Input>
            </FormItem>
            <FormItem :label="$t('zssj')" prop="superiorId" style="width:40%;">
              <Input v-model="addformbase.superiorId" readonly @click.native="showemp_ass" />
            </FormItem>
            <FormItem :label="$t('ssgw')" prop="postId" style="width:40%;">
              <Select v-model="addformbase.levelId">
                <Option v-for="item in postList" :key="item.id" :value="item.id">{{ item.postName }}</Option>
              </Select>
            </FormItem>
            <FormItem :label="$t('jb')" prop="levelId" style="width:40%;">
              <Select v-model="addformbase.levelId">
                <Option v-for="item in levelList" :key="item.id" :value="item.id">{{ item.levelName }}</Option>
              </Select>
            </FormItem>
          ...
          >
            ...
            <div>
              {{ $t("pxxx") }}
              <Checkbox v-model="addformbase.isTrain">{{ $t('sfxypx') }}</Checkbox>
            </div>
          </div>
          <Divider />
          <Form
          ...
          >
            ...
            <FormItem :label="$t('pxfs')" prop="trainWay" style="width:40%;">
              <Input v-model="addformbase.trainWay"></Input>
            </FormItem>
            <FormItem :label="$t('pxlex')" prop="trainType" style="width:40%;">
              <Input v-model="addformbase.trainType"></Input>
            </FormItem>
            <FormItem :label="$t('pxdd')" prop="trainAddress" style="width:40%;">
            ...
            <FormItem :label="$t('pxfzr')" prop="trainHandle" style="width:40%;">
              <Input v-model="addformbase.trainHandle"></Input>
            </FormItem>
            <FormItem :label="$t('sfxyks')" prop="isTest" style="width:40%;">
              <Input v-model="addformbase.isTest"></Input>
            </FormItem>
          </Form>
        </Card>
      </div>
