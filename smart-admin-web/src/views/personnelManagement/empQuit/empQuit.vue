        ...
        <div style="width:100%;height:calc(80vh)">
            ...
            <Card class="warp-card" dis-hover>
                <div style="margin-bottom:20px;">
                    ...
                    <Button style="margin-right:15px;" v-privilege="['59-65-45']" @click="created" type="warning">{{ $t('lzsq') }}</Button>
                </div>
...
export default {
  ...
  data () {
    return {
      ...
      columns4: [
        ...
        {
          title: this.$t('sqrsszz'),
          key: 'organizeName'
        },
        {
          title: this.$t('sqrssgw'),
          key: 'postName'
        },
        {
          title: this.$t('tjrq'),
  ...
  methods: {
    ...
    getempInductionList () {
      this.loading = true;
      empQuit.getempQuit(this.searchform).then(res => {
        this.loading = false;
