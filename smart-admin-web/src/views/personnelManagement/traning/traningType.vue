...
export default {
  ...
  methods: {
    ...
    ok () {
      ...
      this.formItem.createName = this.$store.state.user.userLoginInfo.nickName;
      ...
      this.$refs.formRef.validate(valid => {
        ...
        if (!valid) {
          ...
          training.addTrainingType(data).then(res => {
            this.getTestType();
    ...
    ok_edit () {
      this.formItem.createId = this.$store.state.user.userLoginInfo.userId;
      training.updateTrainingType(this.formItem).then(res => {
        this.getTestType();
        this.formItem = Object.assign({}, defaultFormItem);
    ...
    remove (id) {
      const ids = [];
      ids.push(id);
      training.deleteTrainingType(ids).then(res => {
