    ...
    <Card dis-hover>
      ...
      <div>
        <Form
          ...
          inline
        >
          <FormItem :label="$t('hehudianhua')" style="width: 20%">
            <span>{{ addformbase.customerTel }}</span>
          </FormItem>
          <FormItem :label="$t('tousuleixing')" style="width: 20%">
            <span>{{ addformbase.complainTypeName }}</span>
          </FormItem>
          <FormItem :label="$t('tousushijian')" style="width: 20%">
            <span>{{ addformbase.createtimeStr }}</span>
          </FormItem>
          <FormItem :label="$t('tousuzhuangtai')" style="width: 20%">
            <span>{{
              addformbase.status === 0 ? $t("genjingzhong") : $t("jieshu")
            }}</span>
          </FormItem>
          <FormItem :label="$t('tousuneirong')" style="width: 100%">
            <span>{{ addformbase.complaintsContent }}</span>
          </FormItem>
          <FormItem :label="$t('tousufangshi')" style="width: 100%">
            <Input
              placeholder="请输入内容"
              type="text"
...
export default {
  ...
  methods: {
    addOrUpdateEmail () {
      ...
      customerComplaintsList.doFollowStorage(data).then(res => {
        console.log(res.ret);
