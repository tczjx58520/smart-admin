  ...
  methods: {
    ...
    handsave () {
      ...
      const data = {
        ...
        signPersonIds: this.addformbase.checkPerson
      };
      countersign.addcountersign(data).then((res) => {
        if (res.ret === 200) {
