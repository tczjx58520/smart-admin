...
export default {
  ...
  methods: {
    ...
    selectmyorg (list, currentselect) {
      console.log(list, currentselect, this.selected.indexOf(currentselect), this.selected);
      // if (currentselect.checked) {
      //   this.selected.push(currentselect);
      //   console.log(`触发了手动选择=============================================================${this.i}`, this.selected);
      // } else {
      //   console.log(`触发了去除=============================================================${this.i}`, this.selected);
      //   this.selected.splice(this.selected.indexOf(currentselect), 1);
      // }
      this.i++;
      this.$emit('addmyorg', list);
    },
    // 重置搜索内容'
    resetSearch () {
      this.searchKeywords = '';
