  ...
  watch: {
    modalstat () {
      ...
      if (this.modalstat) {
        ...
        this.addformbase.nextActions = [];
        for (const value2 of this.addformbase.stepNextConditionVos) {
          this.addformbase.nextActions.push(value2.myid);
        }
