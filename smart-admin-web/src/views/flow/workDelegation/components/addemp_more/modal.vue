...
export default {
  ...
  watch: {
    modalstat () {
      ...
      console.log('type======', this.type, this.memberId);
      if (this.memberId.entrustedPersonIds !== null && this.memberId.entrustedPersonIds !== undefined) {
        this.formValidate.serviceIdList = this.memberId.entrustedPersonIds.split(',').map(Number);
      }
