...
export default {
            ...
            return h('div', [
              h(
                'span',
                {
                  ...
                  domProps: {
                    title: `${params.row.sendPersonName} / ${DateStr}`
                  }
                },
                `${params.row.sendPersonName} / ${DateStr}`
              )
            ]);
          }
        },
  ...
  methods: {
    ...
    async getUserLoginLogPage () {
      ...
      try {
        this.loading = true;
        let result = await distribute.mywatchList(this.searchform);
        this.loading = false;
