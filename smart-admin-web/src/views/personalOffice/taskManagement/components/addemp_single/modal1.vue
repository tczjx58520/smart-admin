            ...
            <Row :gutter="16">
              <Form :model="searchform"
                ...
                <FormItem prop="origin"
                          :label="$t('usermanage_view.role')"
                          style="width:100%">
                  <Select v-model="searchform.roleOa"
                          style="width:100%">
...
export default {
  ...
  watch: {
    modalstat () {
      ...
      if (this.type === 1) {
        if (this.memberId.testHandle !== null && this.memberId.testHandle !== undefined) {
          console.log('this.memberId.testHandle=========>', this.memberId.testHandle);
          this.formValidate.serviceIdList = this.memberId.testHandle.split(',').map(Number);
        }
      } else if (this.type === 2) {
        if (this.memberId.empIds !== null && this.memberId.empIds !== undefined) {
          this.formValidate.serviceIdList = this.memberId.empIds.split(',').map(Number);
        }
      } else {
        if (this.memberId.checkPerson !== null && this.memberId.checkPerson !== undefined) {
          console.log();
